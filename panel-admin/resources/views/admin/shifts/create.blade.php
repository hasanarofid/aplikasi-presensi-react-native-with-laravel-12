...
@section('title', 'Define Operational Shift')

@section('content')
<div class="w-full">
    <div class="mb-10 flex items-center justify-between">
        <div>
            <p class="text-sm text-slate-500 font-medium tracking-wide">Establish a new temporal boundary for workforce attendance.</p>
        </div>
    ...
    <div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-100 mb-8">
        <form action="{{ route('admin.shifts.store') }}" method="POST" class="space-y-8">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="name" placeholder="e.g. Night Watch" value="{{ old('name') }}" 
